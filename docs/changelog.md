...
### 新增
- **版本号更新**：包版本、README 与更新日志统一推进到 `0.13.0`
- **对话界面设计文档**：新增对话页设计说明，补充页面目标、交互流程、状态展示与接口约束

### 改进
- **文档同步**：同步整理 README、用户手册、API 参考与部署说明中的版本引用与页面能力描述
- **历史文档归档**：继续将已收敛的迁移/阶段性设计说明保留到历史目录，避免与当前主线文档混淆

### 修复
- **版本标识不一致**：解决 README 与包版本之间的版本号偏差，统一对外展示为 `0.13.0`

## v0.12.2 (2026-07-09)

### 新增
- **版本号统一推进**：包版本、README 与版本日志同步更新到 `0.12.2`
- **本轮更新说明**：补充本次大版本整合后的文档同步记录，方便回溯当前主线能力

### 改进
- **版本引用收敛**：用户文档、部署说明与更新日志的版本标识继续保持一致，减少发布检查时的手工比对成本
- **历史文档归档**：将已完成迁移/收敛的设计说明转入历史目录，保留演进脉络但避免与当前主线文档混淆

### 修复
- **版本标识不一致**：解决 README 与包版本之间的版本号偏差，统一对外展示为 `0.12.2`
